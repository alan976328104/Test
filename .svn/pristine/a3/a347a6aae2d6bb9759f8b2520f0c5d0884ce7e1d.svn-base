...
public class Excleparser1 {
    private static final Logger logger = LoggerFactory.getLogger(Excleparser1.class);
     ...
     */
    public Excleparser1 parse(InputStream stream,Integer begin,Integer end)
     ...
     * @throws ParseException
     */
    public synchronized Excleparser1 parse(InputStream stream, int sheetId)
            throws InvalidFormatException, IOException, ParseException {
        // 每次转换前都清空数据
        datas.clear();
        // 打开表格文件输入流
