(function(){
	var d=document,
		...
		ids=null,
		oInput=null;
	document.write('<iframe frameborder=0 style="display:none;position:absolute;" width="200" height="230" scrolling="no" name="sangcalender" id="sangcalender"></iframe>');
	var f=window.frames['sangcalender'];
	var ff=d.getElementById('sangcalender');
	var fd=f.document;
	fd.open();
	fd.write('<!DOCTYPE html><html><head><style type="text/css">#yearL, #monthL, #monthR, #yearR, #hoursL, #hoursR, #minL, #minR, #y, #m, #h, #i, #s{cursor:pointer;font-weight: bolder;}.calenderClose a{display:block;width:13px;line-height:13px;border:1px solid #cccccc;background-color:#eeeeee;color:#666; text-decoration:none}.calenderClose a:hover{color:red}td{text-align:center}#calenderDay{cursor:pointer;color:#5994D7;}#calenderDay table td{border:1px solid F1F1F1;} #calenderDay table td:hover{color:#FFFFFF;background:#5985c7 !important;}body{font-size:12px;padding:0;margin:0}.col666{color:#CCCCCC}.bg9ebdd6{background-color:#2B579A;color:#FFF;}.spanBtn{color: #5985c7;border: 1px solid #ccc;font-size: 12px;padding:0px 5px;line-height: 18px;height: 17px;font-weight: bold;border-radius: 2px;width: 18px;}</style></head><body onselectstart="return false" style="-moz-user-select:none" oncontextmenu="return false">')
	fd.write('<table width="100%" bgcolor="#FBFBFB" cellspacing="1" cellpadding="0" style="padding:2px 5px 5px 5px;border:1px solid #CCCCCC;border-radius: 3px;">'+
			 '<tr><td><table border="0" cellspacing="0" bgcolor="#FBFBFB" cellpadding="0" width="100%">'+
			 '<tr><td width="20" height="25" align="center" id="yearL" title="上一年"><span class="spanBtn">«</span></td>'+
			 '<td width="12" align="center" id="monthL" title="上一月"><span class="spanBtn" style="margin-left:3px;">‹</span></td><td align="center">'+
			 '<span id="y" title="点击选择年份" style="margin-right:2px;"></span>年<span id="m" title="点击选择月份" style="margin:0px 2px;"></span>月</td>'+
			 '<td width="12" align="center" id="monthR" title="下一月"><span class="spanBtn" style="margin-right:3px;">›</span></td>'+
			 '<td width="20" align="center" id="yearR" title="下一年"><span class="spanBtn">»</span></td></tr></table></td></tr>'+
			 '<tr bgcolor="#FFFFFF"><td><table width="100%" border="0" bgcolor="#FBFBFB" style="color:#666666" cellspacing="1" cellpadding="0" >'+
			 '<tr bgcolor="#FBFBFB" height="18"><td>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td>六</td></tr></table></td></tr>'+
			 '<tr bgcolor="#FFFFFF"><td><div id="calenderDay"></div></td></tr>'+
			 '<tr><td><table style="display:none" border="0" bgcolor="#eeeeee" cellpadding="0" cellspacing="0" width="100%">'+
	...
	function createOption(type,v){
		...
		str+='<select id="calenderSelect" style="border-radius: 5px !important;">';
		if(type=="y"){
			i=nowY+5;i2=1990;
			create(i,i2);
			return;
