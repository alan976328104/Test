...
public class ZipUtils {
	 ...
	 * @throws Exception
	 */
	public static void compress(String fileOutName, List<File> files)
			throws Exception {
		try {
	 ...
	 * @throws Exception
	 */
	public static void compress(File srcFile, ZipOutputStream zipOutputStream,
	...
	public static void compressList(ZipOutputStream out,List<File> sourceFile, String base)
			throws Exception {
...
//		out.close();
	 ...
	 * @throws Exception
	 */
	private static void compressDir(File dir, ZipOutputStream zipOutputStream,
			String basePath) throws Exception {
		try {
			// 获取文件列表
			...
			if (files.length < 1) {
				ZipEntry zipEntry = new ZipEntry(basePath + dir.getName()
						+ PATCH);
			...
			for (int i = 0, size = files.length; i < size; i++) {
				compress(files[i], zipOutputStream, basePath + dir.getName()
						+ PATCH);
			}
		} catch (Exception e) {
			throw new Exception(e.getMessage(), e);
	...
	private static void compressFile(File file,
			ZipOutputStream zipOutputStream, String dir) throws Exception {
		try {
			// 压缩文件
	 ...
	 * @throws Exception
	 */
	public static void decodeToBase64(File destFile, String encodeStr)
			throws Exception {
		try {
	...
	public static void decompress(String srcFileName, String destFileName)
			throws Exception {
//		try {
...
//		}
	 ...
	 * @throws Exception
	 */
	private static void decompressFile(File destFile, InputStream inputStream)
			throws Exception {
		try {
			// 文件输入流
	...
	public static void main(String[] args) {
		try {
			ZipOutputStream zipOutputStream = new ZipOutputStream(
					new FileOutputStream(new File("F:/a.zip")));
		//	zipOutputStream.setEncoding(CHAR_SET);

			List<File> files = new ArrayList<File>();
			files.add(new File("F:/files/pgoffice.docx"));
